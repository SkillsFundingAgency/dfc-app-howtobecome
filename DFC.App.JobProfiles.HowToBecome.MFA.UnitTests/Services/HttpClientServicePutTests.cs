...
namespace DFC.App.JobProfiles.HowToBecome.MFA.UnitTests.Services
{
    ...
    public class HttpClientServicePutTests
    {
        ...
        public async Task PutFullJobProfileAsyncReturnsOkStatusCodeForExistingId()
        {
            ...
            // act
            var result = await httpClientService.PutFullJobProfileAsync(A.Fake<HowToBecomeSegmentModel>()).ConfigureAwait(false);
        ...
        public async Task PutFullJobProfileAsyncReturnsExceptionForBadStatus()
        {
            ...
            // act
            var exceptionResult = await Assert.ThrowsAsync<HttpRequestException>(async () => await httpClientService.PutFullJobProfileAsync(A.Fake<HowToBecomeSegmentModel>()).ConfigureAwait(false)).ConfigureAwait(false);
